...
public class ElementUtil {
	...
	@Step("checking the element : {0} is displyed on the page..")
	...
	public WebElement getElement(By locator) {
		...
		log.info("element is found with the locator.." + locator);
	...
	public boolean isElementExist(By locator) {
		if (getElementsCount(locator) == 1) {
			...
			log.error("the element : " + locator + " is not present on the page");
			return false;
		}
	}
